  ...
  return (
    ...
    <>
        <div className="navbar">
                <div className=' flex justify-between bg-blue-500 h-20 p-4 sticky top-0 z-50 shadow-md border-t border-white'>
                    ...
                    <ul className="hidden md:flex justify-center gap-6 p-2 text-white font-bold ">
                        ...
                        <li><Link to="/"><i className="bi bi-cart-fill"></i>Cart</Link></li>
                    </ul>
        ...
        <div className="md:hidden bg-blue-600 text-white font-bold px-6 py-4 space-y-3 sticky top-0 z-50">
          ...
          <Link to="/" className="block flex gap-2"><i className="bi bi-bag-fill"></i>Shop</Link>
          <Link to="/" className="block flex gap-2"><i className="bi bi-boxes"></i>Orders</Link>
          <Link to="/" className="block flex gap-2"><i className="bi bi-file-person-fill"></i>About Us</Link>
          <Link to="/" className="block flex gap-2"><i className="bi bi-person-lines-fill"></i>Contact</Link>
          <Link to="/" className="block flex gap-2"><i className="bi bi-box-arrow-in-right mr-1"></i>Log In</Link>
          <Link to="/" className="block flex gap-2"><i className="bi bi-cart-fill mr-1"></i>Cart</Link>
        </div>
      )}
